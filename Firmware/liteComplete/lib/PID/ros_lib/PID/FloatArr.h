#ifndef _ROS_PID_FloatArr_h
#define _ROS_PID_FloatArr_h
...
namespace PID
{
  ...
  class FloatArr : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "PID/FloatArr"; };
    virtual const char * getMD5() override { return "a5efdc7608f256f976ad7573b0f4e032"; };
